...
public class DepartamentoTest {
	...
	public void criaDeptoValido() {
		...
		Assert.assertEquals(vendas.getChefe().getMatricula(), 
				123);
		Assert.assertEquals(ana.getDepartamentoChefia().getCodDepto(), 
				1);
		Assert.assertEquals(ana.getDepartamentoAlocado().getCodDepto(), 
				1);
